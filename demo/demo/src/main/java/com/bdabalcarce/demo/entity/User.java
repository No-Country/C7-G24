...
public class User implements Serializable {
    ...
    public User(String userDni, String userRol, String userName, String userLastname, String userEmail, String userPhone, String userAdress, String userVehicle, String userAvailability, List<Donation> donaciones) {
    ...
    public User(String userdni, String username, String userlastname, String useremail, String userphone) {
        this.userDni = userdni;
        this.userName = username;
        this.userLastname = userlastname;
        this.userEmail = useremail;
